...
<body>
    ...
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <h2 class="h4 mb-1">Registrar nuevo refugio</h2>
                <p class="text-muted">Completa los datos del refugio o albergue.</p>

                <div class="card shadow-sm">
                    <div class="card-body">
                        <form id="form-crear-refugio">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="paso2-direccion" class="form-control" rows="3"
                                          placeholder="Ej: Av. Principal, al lado de la iglesia" required></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="paso2-foto" class="form-label">Foto del refugio <small class="text-muted">(opcional)</small></label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="cf-turnstile" data-sitekey="<?= $siteKey ?>"
                                     data-callback="onTurnstileRefugioCallback"></div>
                            </div>

                            <input type="hidden" name="turnstile_token" id="turnstile_token_refugio">

                            <button type="submit" class="btn btn-danger w-100">
                                <i class="bi bi-check-circle"></i> Registrar refugio
                            </button>
                        </form>
                    </div>
                </div>
    ...
    <script>
    function onTurnstileRefugioCallback(token) {
        document.getElementById('turnstile_token_refugio').value = token;
    }

    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('form-crear-refugio');
        if (!form) return;
        ...
        form.addEventListener('submit', function (e) {
            ...
            const tokenInput = document.getElementById('turnstile_token_refugio');
            ...
            if (!token) {
                ...
                btn.disabled = false;
                btn.innerHTML = '<i class="bi bi-check-circle"></i> Registrar refugio';
                return;
            }
            ...
            function enviarRefugio(fotoUrl) {
                const data = {
                ...
                .then(function (res) {
                    if (res.error) {
                        ...
                        btn.disabled = false;
                        btn.innerHTML = '<i class="bi bi-check-circle"></i> Registrar refugio';
                    } else if (res.refugio_id) {
                        window.location.href = '/refugio/' + res.refugio_id;
                    }
                })
                .catch(function () {
                    Swal.fire({
