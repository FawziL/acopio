...
<body>
                    ...
                    <div class="card-body small">
                        <form id="form-crear">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="tipo-entidad" class="form-select" required>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Mostrar/ocultar campos según tipo (por ahora todos igual)
        document.getElementById('tipo-entidad').addEventListener('change', function () {
            // placeholder para futura lógica condicional
        });
        ...
        form.addEventListener('submit', function (e) {
            ...
            const apiUrl = tipo === 'centro' ? '/api/centros.php' : '/api/refugios.php';
            const redirectPath = tipo === 'centro' ? '/centro-acopio/' : '/refugio/';

            function enviar(fotoUrl) {
                const data = { ...baseData, foto_url: fotoUrl || '' };
                ...
                .then(function (res) {
                    if (res.error) {
                        ...
                        const id = res.centro_id || res.refugio_id;
                        if (id) {
